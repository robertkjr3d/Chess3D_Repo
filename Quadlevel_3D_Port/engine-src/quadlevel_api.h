...
//   ql_generate_mate2_puzzle() — generates a new random puzzle
//     Returns: "FEN|first_move" or "" if generation failed
//   ql_get_cached_mate2_puzzle() — returns random puzzle from cache
//     Returns: "FEN|first_move" or "" if cache empty
//   ql_is_mate_in_2() — check if current position is mate-in-2
//     Returns: 1 if mate-in-2, 0 otherwise
